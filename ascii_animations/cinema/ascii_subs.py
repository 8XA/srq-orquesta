...
def ascii_animation(message, scraper_num):
    ...
    while read_settings("run_animation") - scraper_num != 0:
        ...
        while k < 100:
            ...
            if read_settings("run_animation") - scraper_num == 0 or \
                    rows_num != columns_number_func(side='lines', clean_screen=False) or \
                    cols_num != columns_number_func(clean_screen=False):
                break
            sleep(0.1)
